 ...
 * @description Branch selector, tags, commit history, and Clone dropdown.
 * @author prssbayu-oss
 */
...
function BranchAndCodeBar( state ) {
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 my-4">
      ...
      <div class="flex items-center gap-2 text-xs">
        <button id="commit-history-btn" class="bg-[#21262d] hover:bg-[#30363d] border border-[#30363d] text-[#7d8590] hover:text-[#f0f6fc] px-2.5 py-1.5 rounded-md flex items-center gap-1.5 transition-colors">
